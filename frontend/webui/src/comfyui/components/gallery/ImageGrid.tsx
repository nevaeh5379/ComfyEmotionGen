  ...
  return (
    ...
    >
      {items.map((img) => {
        ...
        const isBroken = brokenHashes.has(img.hash)
...
interface ImageGridItemProps {
  ...
  isPinned: boolean
  togglePin: ((hash: string) => void) | undefined
  isFocused: boolean
  onFocus: ((hash: string | null) => void) | undefined
  imageLazyLoad: boolean
  isBroken: boolean
  onSetBroken: (hash: string) => void
}
