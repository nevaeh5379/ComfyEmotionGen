...
export const SavedImagesGallery = memo(function SavedImagesGallery({
  ...
  const visibleGroups = useMemo(() => {
    ...
    for (const g of groups) {
      if (lowerFilename !== null && !g.filename.toLowerCase().includes(lowerFilename)) {
        continue
      }
  ...
  const handleBulkAction = useCallback(
    async (targetStatus: CurationStatus): Promise<void> => {
      ...
      try {
        ...
        exitSelectionMode()
        setTimeout((): void => { setBulkActionMessage(null); }, 3000)
        reload()
      } catch {
  ...
  const handleBulkDownload = useCallback((): void => {
    ...
    try {
      ...
      for (const hash of selectedHashesRef.current) {
        ...
        const filename = img !== undefined ? getImageFilename(img) : `${hash}.png`
      ...
      <ContextMenuTrigger asChild>
        <div className="flex flex-1 flex-col">
            ...
            <div className="sticky top-0 z-40 shrink-0 border-b border-line bg-panel px-4 py-2">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select
                    value={sortKey}
                    onValueChange={(k): void => { toggleSort(k as GallerySortKey); }}
                  >
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={(): void => { toggleSort(sortKey); }}
                ...
                <div className="flex items-center gap-2">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={(): void => { void handleAutoTagAllEmpty(); }}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-[160px]">
                      ...
                      <DropdownMenuSeparator />
                      <DropdownMenuItem
                        onClick={(): void => { void handleEmptyTrash(); }}
                  ...
                  <div className="flex flex-col gap-2 md:flex-row md:items-center">
                    ...
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 md:flex md:items-center">
                      <Input
                        ...
                        onChange={(e): void => { setFilenameFilter(e.target.value); }}
                      ...
                      <Input
                        ...
                        placeholder="태그 필터"
                        value={tagFilter}
                        onChange={(e): void => { setTagFilter(e.target.value); }}
                        onContextMenu={(e): void => { e.stopPropagation(); }}
                      />
                      <Input
                        ...
                        onChange={(e): void => { setMetadataFilter(e.target.value); }}
                        onContextMenu={(e): void => { e.stopPropagation(); }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between border-t border-line/40 pt-2 md:border-0 md:pt-0">
                    <div className="flex cursor-pointer items-center gap-2">
                      <Checkbox
                        ...
                        onCheckedChange={(v): void => { setHideRejected(v === true); }}
                      />
                      <Label
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1">
                  <Button
                    ...
                    onClick={(): void => { void handleBulkAction("approved"); }}
                    disabled={bulkActionLoading}
                  >
                  ...
                  <Button
                    ...
                    onClick={(): void => { void handleBulkAction("rejected"); }}
                    disabled={bulkActionLoading}
                  >
                  ...
                  <Button
                    ...
                    onClick={(): void => { void handleBulkAction("pending"); }}
                    disabled={bulkActionLoading}
                  >
                ...
                <div className="flex items-center gap-1">
                  <Button
                    ...
                    onClick={(): void => { void handleBulkAction("trashed"); }}
                    disabled={bulkActionLoading}
                  >
                  ...
                  <Button
                    ...
                    onClick={(): void => { void handleBulkAutoTag(); }}
                    disabled={bulkActionLoading}
                  >
                    <Sparkles className="h-3.5 w-3.5" />
                    일괄 자동 태그
          ...
          <div className="flex-1 p-4" onMouseDown={handleMouseDown}>
              ...
              <div className="flex flex-wrap items-center gap-2 justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={(): void => { setTagSortOrder(tagSortOrder === "count" ? "name" : "count"); }}
                  >
                  ...
                  <Button
                    ...
                    size="sm"
                    className="h-7 px-2 text-[11px] gap-1 font-semibold hover:bg-accent"
                    onClick={(): void => { setIsTagPanelExpanded(!isTagPanelExpanded); }}
                  >
                    {isTagPanelExpanded ? (
                      <>
                  ...
                  <div className="relative w-36 sm:w-44">
                    ...
                    <input
                      ...
                      value={subTagQuery}
                      onChange={(e): void => { setSubTagQuery(e.target.value); }}
                      onContextMenu={(e): void => { e.stopPropagation(); }}
                      ...
                      <ContextMenu key={hash}>
                        ...
                        {img && (
                          <ContextMenuContent className="w-48">
                            ...
                            <ContextMenuSeparator />
                            <ContextMenuItem
                              onClick={(): void => { void setStatus(hash, "approved"); }}
                            ...
                            <ContextMenuItem
                              onClick={(): void => { void setStatus(hash, "rejected"); }}
                            ...
                            <ContextMenuItem
                              onClick={(): void => { void setStatus(hash, "pending"); }}
                  ...
                  return (
                    <div key={name} className="rounded-md border p-3">
                      <div className="mb-2 flex flex-wrap items-center gap-2">
                        ...
                        <button
                          type="button"
                          onClick={(): void => { toggleGroupCollapse(name); }}
                        ...
                        {!isCollapsed && (
                          <div className="ml-auto">
                            <Button
                              size="sm"
                              variant="outline"
                              onClick={(): void => { handleRegenerate(name); }}
                            >
                              재생성
                            </Button>
                          </div>
                      ...
                      {!isCollapsed && (
                        <ImageGrid
                          ...
                          setStatus={(hash: string, status: CurationStatus): void => { void setStatus(hash, status); }}
                          onOpen={setSelected}
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <Pagination>
                      <PaginationContent>
                        <PaginationItem>
                          <PaginationPrevious
                            onClick={(): void => { if (groupPage > 1) { setGroupPage(groupPage - 1); } }}
                        ...
                        <PaginationItem>
                          <PaginationNext
                            onClick={(): void => { if (groupPage < groupTotalPages) { setGroupPage(groupPage + 1); } }}
            ...
            ) : effectiveGalleryViewMode === "grid" || pinnedHashes.length === 0 ? (
              <>
                {effectiveGalleryViewMode === "compare" &&
                  pinnedHashes.length === 0 && (
                ...
                <div className="flex flex-col items-center gap-2">
                  <Pagination>
                    <PaginationContent>
                      <PaginationItem>
                        <PaginationPrevious
                          onClick={(): void => { if (page > 1) { setPage(page - 1); } }}
                      ...
                      <PaginationItem>
                        <PaginationNext
                          onClick={(): void => { if (page < totalPages) { setPage(page + 1); } }}
